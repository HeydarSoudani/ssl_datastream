...
class RelationLearner:
  ...
  def relation_train(
    ...
    support_labels_ext = support_labels.unsqueeze(0).repeat(n_known*args.query_num, 1)    #[q, w*sh]
  ...
  def evaluate(self,
    ...
    with torch.no_grad():
      for i, batch in enumerate(val_loader):
        ...
        test_labels_ext = test_labels.unsqueeze(0).repeat(n_known*pt_per_class, 1)        #[nc*sh, q]
